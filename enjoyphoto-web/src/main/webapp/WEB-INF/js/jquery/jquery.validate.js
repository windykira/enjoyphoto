    ...
    $.extend($.validator, {
        ...
        methods: {
            ...
            range: function (value, element, param) {
                return this.optional(element) || ($.trim(value) >= param[0] && $.trim(value) <= param[1]);
            },

            // http://docs.jquery.com/Plugins/Validation/Methods/email
            email: function (value, element) {
                // contributed by Scott Gonzalez: http://projects.scottsplayground.com/email_address_validation/
                return this.optional(element) || /^([a-zA-Z0-9\.-_]+@[a-zA-Z0-9\.-_]+\.[a-zA-Z]{2,4})$/i.test($.trim(value));
            },
            ...
            date: function (value, element) {
                return this.optional(element) || !/Invalid|NaN/.test(new Date($.trim(value)));
            },

            // http://docs.jquery.com/Plugins/Validation/Methods/dateISO
            dateISO: function (value, element) {
                return this.optional(element) || /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test($.trim(value));
            },
